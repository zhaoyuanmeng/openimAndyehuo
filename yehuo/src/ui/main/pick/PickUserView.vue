                    ...
                    <ul v-if="!pickSource">
                        <li @click="pickSource = 'friend'; organizationPathList = []">
                            <a href="#" @click.prevent>
                                <i class="icon-ion-android-contacts" style="padding-right: 6px;"/>
                                选择好友
                            </a>
                        </li>
                        <li @click="pickSource = 'organization'">
                            <a href="#" @click.prevent>
                                <i class="icon-ion-android-document" style="padding-right: 10px;"/>
                                选择组织联系人
                            </a>
                        </li>
                    </ul>
...
.checked-contact-list-container .content .checkbox {
    width: 15px;
    height: 15px;
}
