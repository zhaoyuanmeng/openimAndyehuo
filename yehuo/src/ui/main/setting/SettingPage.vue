    ...
    <div class="setting-container">
        <div class="content">
            ...
            <label>
                ...
                <input type="checkbox" :checked="sharedMiscState.enableNotification"
            ...
            <div>
                {{ $t('setting.lang') }}
                <dropdown class="my-dropdown-toggle" :options="langs" :selected="currentLang"
                    v-on:updateOption="setLang" :placeholder="'Select an Item'" :closeOnOutsideClick="true">
                </dropdown>
            </div>
        </div>
        <footer>
            <!-- <p class="proto-version-info">{{ protoRevision() }}</p> -->
            <!-- <a class="button" href="http://www.chinaxiongan.com.cn/kggs/szcskjgs/index.shtml" target="_blank">
                问题反馈
            </a>
            ...
            <vue-context ref="changePasswordContextMenu" :close-on-scroll="false"
                v-on:close="onChangePasswordContextMenuClose">
                <li>
